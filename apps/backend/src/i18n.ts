...
const exactMessages = {
  pt: {
    ...
    'User role is invalid': 'A permissão do usuário é inválida',
    ...
    'Circuit created successfully': 'Circuito criado com sucesso',
    'Circuit updated successfully': 'Circuito atualizado com sucesso',
    'Circuit not found': 'Circuito nao encontrado',
    'Circuit box saved successfully': 'Box do circuito salvo com sucesso',
    'Circuit box not found': 'Box do circuito nao encontrado',
    'Failed to save circuit': 'Falha ao salvar circuito',
    'Circuit simple name is invalid': 'O nome simples do circuito e invalido',
    'Circuit full name is invalid': 'O nome completo do circuito e invalido',
    'Circuit must be valid': 'O circuito deve ser valido',
    'Box X coordinate is invalid': 'A coordenada X do box e invalida',
    'Box Y coordinate is invalid': 'A coordenada Y do box e invalida',
    ...
    'Scuderia full name must be between 2 and 140 characters': 'O nome oficial da scuderia deve ter entre 2 e 140 caracteres',
    ...
    'Scuderia category is invalid': 'A categoria da scuderia é inválida',
    'Junior team flag is invalid': 'A opção de equipe júnior é inválida',
    'Parent scuderia id is invalid': 'A scuderia pai é inválida',
    'Parent Formula 1 scuderia not found': 'Scuderia pai de Formula 1 não encontrada',
    'Junior teams cannot manage facilities': 'Equipes júnior não podem gerenciar instalações',
    ...
    'Sponsor proposal already under review': 'Proposta de sponsor já está em análise',
    'Sponsor proposal not found': 'Proposta de sponsor não encontrada',
    'Sponsor proposal already reviewed': 'Proposta de sponsor já foi analisada',
    'At least one scuderia must be selected': 'Selecione pelo menos uma scuderia',
    ...
    'Driver salary is below minimum': 'O salario do piloto esta abaixo do minimo',
    'Promotion is only available from a Formula 2 junior team': 'A promocao esta disponivel apenas a partir de uma equipe junior de Formula 2',
    'Parent scuderia has no starter vacancy': 'A scuderia pai nao possui vaga de titular',
  ...
  en: {
    ...
    'Scuderia full name must be between 2 and 140 characters': 'Scuderia full name must be between 2 and 140 characters',
    ...
    'Scuderia category is invalid': 'Scuderia category is invalid',
    'Junior team flag is invalid': 'Junior team flag is invalid',
    'Parent scuderia id is invalid': 'Parent scuderia id is invalid',
    'Parent Formula 1 scuderia not found': 'Parent Formula 1 scuderia not found',
    'Junior teams cannot manage facilities': 'Junior teams cannot manage facilities',
    'Team sponsor not found': 'Team sponsor not found',
    'At least one scuderia must be selected': 'At least one scuderia must be selected',
    'Sponsor proposal already under review': 'Sponsor proposal already under review',
    'Sponsor proposal not found': 'Sponsor proposal not found',
    'Sponsor proposal already reviewed': 'Sponsor proposal already reviewed',
    ...
    'Circuit created successfully': 'Circuit created successfully',
    'Circuit updated successfully': 'Circuit updated successfully',
    'Circuit not found': 'Circuit not found',
    'Circuit box saved successfully': 'Circuit box saved successfully',
    'Circuit box not found': 'Circuit box not found',
    'Failed to save circuit': 'Failed to save circuit',
    'Circuit simple name is invalid': 'Circuit simple name is invalid',
    'Circuit full name is invalid': 'Circuit full name is invalid',
    'Circuit must be valid': 'Circuit must be valid',
    'Box X coordinate is invalid': 'Box X coordinate is invalid',
    'Box Y coordinate is invalid': 'Box Y coordinate is invalid',
    'Driver salary is below minimum': 'Driver salary is below minimum',
    'Promotion is only available from a Formula 2 junior team': 'Promotion is only available from a Formula 2 junior team',
    'Parent scuderia has no starter vacancy': 'Parent scuderia has no starter vacancy',
  ...
  es: {
    ...
    'User role is invalid': 'El rol del usuario es inválido',
    ...
    'Circuit created successfully': 'Circuito creado correctamente',
    'Circuit updated successfully': 'Circuito actualizado correctamente',
    'Circuit not found': 'Circuito no encontrado',
    'Circuit box saved successfully': 'Box del circuito guardado correctamente',
    'Circuit box not found': 'Box del circuito no encontrado',
    'Failed to save circuit': 'No se pudo guardar el circuito',
    'Circuit simple name is invalid': 'El nombre simple del circuito es invalido',
    'Circuit full name is invalid': 'El nombre completo del circuito es invalido',
    'Circuit must be valid': 'El circuito debe ser valido',
    'Box X coordinate is invalid': 'La coordenada X del box es invalida',
    'Box Y coordinate is invalid': 'La coordenada Y del box es invalida',
    ...
    'Scuderia full name must be between 2 and 140 characters': 'El nombre oficial de la scuderia debe tener entre 2 y 140 caracteres',
    ...
    'Scuderia category is invalid': 'La categoría de la scuderia no es válida',
    'Junior team flag is invalid': 'La opción de equipo junior no es válida',
    'Parent scuderia id is invalid': 'La scuderia padre no es válida',
    'Parent Formula 1 scuderia not found': 'Scuderia padre de Formula 1 no encontrada',
    'Junior teams cannot manage facilities': 'Los equipos junior no pueden gestionar instalaciones',
    ...
    'Sponsor proposal already under review': 'La propuesta de sponsor ya está en análisis',
    'Sponsor proposal not found': 'Propuesta de sponsor no encontrada',
    'Sponsor proposal already reviewed': 'La propuesta de sponsor ya fue analizada',
    'At least one scuderia must be selected': 'Selecciona al menos una scuderia',
    ...
    'Driver salary is below minimum': 'El salario del piloto esta por debajo del minimo',
    'Promotion is only available from a Formula 2 junior team': 'La promocion solo esta disponible desde un equipo junior de Formula 2',
    'Parent scuderia has no starter vacancy': 'La scuderia padre no tiene vacante de titular',
