...
const exactMessages = {
  pt: {
    ...
    'Financial system status is invalid': 'O status do sistema financeiro é inválido',
    'Financial system updated successfully': 'Sistema financeiro atualizado com sucesso',
    'Failed to load financial system status': 'Falha ao carregar status do sistema financeiro',
    'Failed to update financial system status': 'Falha ao atualizar status do sistema financeiro',
    'Financial system is disabled': 'O sistema financeiro está desligado',
    ...
    'Commercial momentum adjustment is invalid': 'O ajuste de momento comercial é inválido',
    'Sponsor happiness changes must be an array': 'As mudanças de felicidade dos sponsors devem ser uma lista',
    'Sponsor happiness adjustment is invalid': 'O ajuste de felicidade do sponsor é inválido',
    'Commercial momentum updated successfully': 'Momento comercial atualizado com sucesso',
    'Failed to update commercial momentum': 'Falha ao atualizar momento comercial',
    ...
    'Failed to load public host': 'Falha ao carregar host publico',
    'Public user updated successfully': 'Usuario publico atualizado com sucesso',
    'Public user deleted successfully': 'Usuario publico excluido com sucesso',
    'Failed to update public user': 'Falha ao atualizar usuario publico',
    'Failed to delete public user': 'Falha ao excluir usuario publico',
    'Public user not found': 'Usuario publico nao encontrado',
    'Public circuit updated successfully': 'Circuito publico atualizado com sucesso',
    'Public circuit deleted successfully': 'Circuito publico excluido com sucesso',
    'Failed to update public circuit': 'Falha ao atualizar circuito publico',
    'Failed to delete public circuit': 'Falha ao excluir circuito publico',
    'Public circuit not found': 'Circuito publico nao encontrado',
  },
  en: {
    ...
    'Commercial momentum adjustment is invalid': 'Commercial momentum adjustment is invalid',
    'Sponsor happiness changes must be an array': 'Sponsor happiness changes must be an array',
    'Sponsor happiness adjustment is invalid': 'Sponsor happiness adjustment is invalid',
    'Commercial momentum updated successfully': 'Commercial momentum updated successfully',
    'Failed to update commercial momentum': 'Failed to update commercial momentum',
    'Financial system status is invalid': 'Financial system status is invalid',
    'Financial system updated successfully': 'Financial system updated successfully',
    'Failed to load financial system status': 'Failed to load financial system status',
    'Failed to update financial system status': 'Failed to update financial system status',
    'Financial system is disabled': 'Financial system is disabled',
    ...
    'Failed to load public host': 'Failed to load public host',
    'Public user updated successfully': 'Public user updated successfully',
    'Public user deleted successfully': 'Public user deleted successfully',
    'Failed to update public user': 'Failed to update public user',
    'Failed to delete public user': 'Failed to delete public user',
    'Public user not found': 'Public user not found',
    'Public circuit updated successfully': 'Public circuit updated successfully',
    'Public circuit deleted successfully': 'Public circuit deleted successfully',
    'Failed to update public circuit': 'Failed to update public circuit',
    'Failed to delete public circuit': 'Failed to delete public circuit',
    'Public circuit not found': 'Public circuit not found',
  ...
  es: {
    ...
    'Financial system status is invalid': 'El estado del sistema financiero no es válido',
    'Financial system updated successfully': 'Sistema financiero actualizado correctamente',
    'Failed to load financial system status': 'No se pudo cargar el estado del sistema financiero',
    'Failed to update financial system status': 'No se pudo actualizar el estado del sistema financiero',
    'Financial system is disabled': 'El sistema financiero está desactivado',
    ...
    'Commercial momentum adjustment is invalid': 'El ajuste de momento comercial no es válido',
    'Sponsor happiness changes must be an array': 'Los cambios de felicidad de sponsors deben ser una lista',
    'Sponsor happiness adjustment is invalid': 'El ajuste de felicidad del sponsor no es válido',
    'Commercial momentum updated successfully': 'Momento comercial actualizado correctamente',
    'Failed to update commercial momentum': 'No se pudo actualizar el momento comercial',
    ...
    'Failed to load public host': 'No se pudo cargar el host publico',
    'Public user updated successfully': 'Usuario publico actualizado correctamente',
    'Public user deleted successfully': 'Usuario publico eliminado correctamente',
    'Failed to update public user': 'No se pudo actualizar el usuario publico',
    'Failed to delete public user': 'No se pudo eliminar el usuario publico',
    'Public user not found': 'Usuario publico no encontrado',
    'Public circuit updated successfully': 'Circuito publico actualizado correctamente',
    'Public circuit deleted successfully': 'Circuito publico eliminado correctamente',
    'Failed to update public circuit': 'No se pudo actualizar el circuito publico',
    'Failed to delete public circuit': 'No se pudo eliminar el circuito publico',
    'Public circuit not found': 'Circuito publico no encontrado',
  },
} as const;
