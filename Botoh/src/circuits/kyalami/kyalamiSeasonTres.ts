...
const kyalamiSeasonTres_raw = readFileSync(join(__dirname, "kyalamiSeasonTres.hbs"), "utf-8");

const KYALAMISEASONTRES_INFO: CircuitInfo = {
  finishLine: {
    bounds: {
      minX: 226,
      maxX: 258,
  ...
  name: "Kyalami Grand Prix Circuit By Ximb and Nanoseb - NewgenV3",
  boxLine: {
    minX: -788,
    maxX: 222,
    minY: 1230,
  ...
  BestTime: bestTimes.kyalamiSeasonTres,
...
export const KYALAMISEASONTRES: Circuit = {
  map: kyalamiSeasonTres_raw,
  info: KYALAMISEASONTRES_INFO,
};
