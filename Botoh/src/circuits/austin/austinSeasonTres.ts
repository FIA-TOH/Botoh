...
const AUSTINSEASONTRES_INFO: CircuitInfo = {
  ...
  checkpoints: [],
  lastPlace: {
    x: austinSeasonTres_json.redSpawnPoints[austinSeasonTres_json.redSpawnPoints.length - 1][0],
    y: austinSeasonTres_json.redSpawnPoints[austinSeasonTres_json.redSpawnPoints.length - 1][1],
  },
