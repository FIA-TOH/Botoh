...
const silverstonePublic_raw = readFileSync(
  join(__dirname, "silverstonePublic.hbs"),
  "utf-8"
);
...
const SILVERSTONEPUBLIC_INFO: CircuitInfo = {
  ...
  checkpoints: [],
  lastPlace: {
    x: silverstonePublic_json.redSpawnPoints[
      silverstonePublic_json.redSpawnPoints.length - 1
    ][0],
    y: silverstonePublic_json.redSpawnPoints[
      silverstonePublic_json.redSpawnPoints.length - 1
    ][1],
  },
