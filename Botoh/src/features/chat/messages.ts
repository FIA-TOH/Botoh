...
export const MESSAGES = {
  ...
  GEAR_CHANGED: (arrow: string, gear: string, rpm: string): LocalizedMessageFunction => ({
    en: replaceTemplateString(en_messages.GEAR_CHANGED, { arrow, gear, rpm }),
    es: replaceTemplateString(es_messages.GEAR_CHANGED, { arrow, gear, rpm }),
    fr: replaceTemplateString(fr_messages.GEAR_CHANGED, { arrow, gear, rpm }),
    tr: replaceTemplateString(tr_messages.GEAR_CHANGED, { arrow, gear, rpm }),
    pt: replaceTemplateString(pt_messages.GEAR_CHANGED, { arrow, gear, rpm }),
  }),
  GEAR_INFO: (gear: string, total: string, rpm: string, redline: string, mode: string): LocalizedMessageFunction => ({
    en: replaceTemplateString(en_messages.GEAR_INFO, { gear, total, rpm, redline, mode }),
    es: replaceTemplateString(es_messages.GEAR_INFO, { gear, total, rpm, redline, mode }),
    fr: replaceTemplateString(fr_messages.GEAR_INFO, { gear, total, rpm, redline, mode }),
    tr: replaceTemplateString(tr_messages.GEAR_INFO, { gear, total, rpm, redline, mode }),
    pt: replaceTemplateString(pt_messages.GEAR_INFO, { gear, total, rpm, redline, mode }),
  }),
  GEAR_REJECTED_RANGE: (gear: string): LocalizedMessageFunction => ({
    en: replaceTemplateString(en_messages.GEAR_REJECTED_RANGE, { gear }),
    es: replaceTemplateString(es_messages.GEAR_REJECTED_RANGE, { gear }),
    fr: replaceTemplateString(fr_messages.GEAR_REJECTED_RANGE, { gear }),
    tr: replaceTemplateString(tr_messages.GEAR_REJECTED_RANGE, { gear }),
    pt: replaceTemplateString(pt_messages.GEAR_REJECTED_RANGE, { gear }),
  }),
  GEAR_REJECTED_OVERSPEED: (): LocalizedMessageFunction => ({
    en: en_messages.GEAR_REJECTED_OVERSPEED,
    es: es_messages.GEAR_REJECTED_OVERSPEED,
    fr: fr_messages.GEAR_REJECTED_OVERSPEED,
    tr: tr_messages.GEAR_REJECTED_OVERSPEED,
    pt: pt_messages.GEAR_REJECTED_OVERSPEED,
  }),
  RPM_LIMITER_HIT: (): LocalizedMessageFunction => ({
    en: en_messages.RPM_LIMITER_HIT,
    es: es_messages.RPM_LIMITER_HIT,
    fr: fr_messages.RPM_LIMITER_HIT,
    tr: tr_messages.RPM_LIMITER_HIT,
    pt: pt_messages.RPM_LIMITER_HIT,
  }),
  GEAR_MODE_CHANGED: (mode: string): LocalizedMessageFunction => ({
    en: replaceTemplateString(en_messages.GEAR_MODE_CHANGED, { mode }),
    es: replaceTemplateString(es_messages.GEAR_MODE_CHANGED, { mode }),
    fr: replaceTemplateString(fr_messages.GEAR_MODE_CHANGED, { mode }),
    tr: replaceTemplateString(tr_messages.GEAR_MODE_CHANGED, { mode }),
    pt: replaceTemplateString(pt_messages.GEAR_MODE_CHANGED, { mode }),
  }),
  GEAR_MODE_INVALID: (mode: string): LocalizedMessageFunction => ({
    en: replaceTemplateString(en_messages.GEAR_MODE_INVALID, { mode }),
    es: replaceTemplateString(es_messages.GEAR_MODE_INVALID, { mode }),
    fr: replaceTemplateString(fr_messages.GEAR_MODE_INVALID, { mode }),
    tr: replaceTemplateString(tr_messages.GEAR_MODE_INVALID, { mode }),
    pt: replaceTemplateString(pt_messages.GEAR_MODE_INVALID, { mode }),
  }),
};
